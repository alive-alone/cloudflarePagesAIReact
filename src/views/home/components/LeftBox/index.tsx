...
import { addNewSession, setCurrentIndex, deleteSession } from '@/store/features/chatData';
    ...
    <>
      <div className={styles['body']}>
            ...
            {chatList.map((item, index) => {
              return (
                ...
                >
                  ...
                  <div className={styles['close-btn']} onClick={(e) => {
                    e.stopPropagation();
                    deleteChat(index)
                  }}>
        ...
        <div className={styles['footer']}>
          <div className={styles['newchat-btn']} onClick={() => {
      ...
      <Modal
        ...
        footer={null}
        classNames={{content: styles['chat-type-modal'], header: styles['modal-title']}}
